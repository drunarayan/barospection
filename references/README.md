## References for BAROSpection seminar
...
1. [HR Diagram References](hrd_presentation.md)
...
### Other References
1. [Hyper Physics](http://hyperphysics.phy-astr.gsu.edu/hbase/hframe.html)

1. ![](Electromagneticwave3D.gif){:align="left"}
Electromagnetic waves can be imagined as a self-propagating transverse oscillating wave of electric and magnetic fields. This 3D animation shows a plane linearly polarized wave propagating from left to right. The electric and magnetic fields in such a wave are in phase with each other, reaching minima and maxima together.
{:clear="left"}


1. ![](VisibleEmrWavelengths.svg.png){:align="left"}
