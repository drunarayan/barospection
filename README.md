...
2.|Compute Celestial Coordinates to obtain Live Spectra of Multiple Star Types|[Celestial Coordinates](https://boyceastrows.gleeze.com/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fdrunarayan%2Fbarospection&branch=gh-pages&urlpath=lab%2Ftree%2Fbarospection%2Fnotebooks%2Fbarospection/notebooks/nina_targets_for_spectra_v9.ipynb?reset){:target="_blank"} | TBD|[View Only](https://nbviewer.org/github/drunarayan/barospection/blob/gh-pages/notebooks/barospection/notebooks/nina_targets_for_spectra_v9.ipynb){:target="_blank"}
